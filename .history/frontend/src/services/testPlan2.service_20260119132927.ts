...
class TestPlanService {
  async getTestPlans(projectId: string): Promise<TestPlan[]> {
    const response = await apiService.get(`/test-plans?projectId=${projectId}`);
  ...
  async getPlatforms(projectId: string): Promise<Platform[]> {
    const response = await apiService.get(`/platforms?projectId=${projectId}`);
    return response.data;
  }

  async createPlatform(data: Omit<Platform, 'id'>): Promise<Platform> {
    const response = await apiService.post('/platforms', data);
    return response.data;
  }
  ...
  async getMilestones(projectId: string): Promise<Milestone[]> {
    const response = await apiService.get(`/milestones?projectId=${projectId}`);
    return response.data;
  }
