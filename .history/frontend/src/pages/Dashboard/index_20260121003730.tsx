...
const Dashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setStats({
        totalTestCases: data.totalTestCases || 156,
        totalExecutions: data.totalExecutions || 342,
        openDefects: data.openDefects || 23,
        passedTests: data.passedTests || 245,
        failedTests: data.failedTests || 67,
        blockedTests: data.blockedTests || 12,
        passRate: data.passRate || 71.6,
        testCoverage: data.testCoverage || 84.2,
        automationRate: data.automationRate || 62.5,
      });
    } catch (error) {
