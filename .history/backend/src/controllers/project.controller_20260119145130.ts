...
// @desc    Get platforms for a project
// @route   GET /api/projects/:projectId/platforms
// @access  Private
...
// @desc    Create platform for a project
// @route   POST /api/projects/:projectId/platforms
// @access  Private (Admin, Test Manager)
export const createPlatform = async (
  ...
  try {
    const projectId = req.params.projectId;
    const { name, type, version, isActive } = req.body;
