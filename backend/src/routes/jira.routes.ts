...
// Test connection (no project ID needed)
router.post('/test-connection', testJiraConnection);

// Integration setup - Allow ADMIN, TEST_MANAGER, and TESTER to configure
router.post('/integration/:testProjectId', authorize(['ADMIN', 'TEST_MANAGER', 'TESTER']), setupJiraIntegration);
