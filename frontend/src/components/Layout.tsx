...
const baseMenuSections: MenuSectionConfig[] = [
  ...
  },
  {
    ...
    items: [
      { text: 'Execute Test', icon: <ExecutionsIcon />, path: '/executions/execute' },
      { text: 'Assign Test Case Execution', icon: <AssignmentIcon />, path: '/executions/assign' },
      { text: 'Test Cases Assigned to Me', icon: <PersonIcon />, path: '/executions/my-tests' },
      { text: 'Milestones', icon: <MilestoneIcon />, path: '/executions/milestones' },
  ...
  const menuSections = React.useMemo(() => {
    ...
    if (adminSection) {
      ...
      if (user?.role === 'ADMIN' || user?.role === 'TEST_MANAGER') {
        ...
        adminItems.push({ text: 'Audit Logs', icon: <HistoryIcon />, path: '/admin/audit-logs' });
      }
