            ...
            <Grid item xs={12} md={4}>
              <Paper sx={{ p: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 1 }}>
                  <Chip label={`Total: ${data.testCases.total}`} />
                  <Chip label={`Approved: ${data.testCases.byStatus.approved}`} />
                  <Chip label={`Draft: ${data.testCases.byStatus.draft}`} />
                </Box>
              </Paper>
            </Grid>
            <Grid item xs={12} md={4}>
              <Paper sx={{ p: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 1 }}>
                  <Chip label={`Total: ${data.executions.total}`} />
                  <Chip label={`Passed: ${data.executions.passed}`} />
                  <Chip label={`Failed: ${data.executions.failed}`} />
                  <Chip label={`Pass Rate: ${data.executions.passRate}%`} />
                </Box>
              </Paper>
            </Grid>
            <Grid item xs={12} md={4}>
              <Paper sx={{ p: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 1 }}>
                  <Chip label={`Open: ${data.defects.open}`} />
                  <Chip label={`Resolved: ${data.defects.resolved}`} />
                  <Chip label={`Closed: ${data.defects.closed}`} />
                </Box>
              </Paper>
            </Grid>
          </Grid>
